...
def send_waste_data(waste_level):
    ...
    try:
        ...
        print("✅Sent waste volume, Server Response: {}".format(response.json()))
    except Exception as e:
        print("❌ Failed to send waste volume JSON: {}".format(e))
...
try:
    ...
    while True:
        ...
        waste_volume = {round((waste_level / 34) *30, 2)}
        print("Proximity Sensor: {} cm, Waste Volume: {:.2f} L".format(distance_near, waste_level))
